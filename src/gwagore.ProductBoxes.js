...
/*
function ProductBoxes( jq, data, isie )
{
	var _data;
	...
	function _filterProducts( filters )
	{
		if (typeof _data === 'undefined') {
			return;
		}
	...
	function _getProductBox( data )
	{
		...
		var learnmore = $('.productboxes').attr('data-learnmore');
		var html = '<li><div class="mob-title"><h3>' + data.name + '</h3><p>' + data.brand + '</p></div><a class="normal" href="' + data.url + '"><img src="' + data.image + '" alt="' + data.name + '" width="213" height="213" /></a><div class="info"><h3>' + data.name + '</h3><p>' + data.brand + '</p><p><a href="' + data.url + '" class="more white">' + learnmore + ' <i>&nbsp;</i></a></p></div></li>';
		return $(html);
	}
